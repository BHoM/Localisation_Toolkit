...
namespace BH.Engine.Units
{
    public static partial class Convert
    {
        ...
        public static double FromAreaMomentOfInertia(this double areaMomentOfInertia, AreaMomentOfInertiaUnit unit)
        {
            UN.QuantityValue qv = areaMomentOfInertia;
            return UN.UnitConverter.Convert(qv, unit, AreaMomentOfInertiaUnit.MeterToTheFourth);
        }
        ...
        public static double ToAreaMomentOfInertia(this double metresToTheFourth, AreaMomentOfInertiaUnit unit)
        {
            UN.QuantityValue qv = metresToTheFourth;
            return UN.UnitConverter.Convert(qv, AreaMomentOfInertiaUnit.MeterToTheFourth, unit);
        }
    }
}
