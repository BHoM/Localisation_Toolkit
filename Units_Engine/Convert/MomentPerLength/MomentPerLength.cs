...
namespace BH.Engine.Units
{
    public static partial class Convert
    {
        ...
        public static double FromMomentPerLength(this double momentPerLength, TorquePerLengthUnit unit)
        {
            UN.QuantityValue qv = momentPerLength;
            return UN.UnitConverter.Convert(qv, unit, TorquePerLengthUnit.NewtonMeterPerMeter);
        }
        ...
        public static double ToMomentPerLength(this double newtonMeterPerMeter, TorquePerLengthUnit unit)
        {
            UN.QuantityValue qv = newtonMeterPerMeter;
            return UN.UnitConverter.Convert(qv, TorquePerLengthUnit.NewtonMeterPerMeter, unit);
        }
    }
}
