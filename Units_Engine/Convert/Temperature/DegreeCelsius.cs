...
namespace BH.Engine.Units
{
    public static partial class Convert
    {
        ...
        public static double ToDegreeCelsius(this double kelvins)
        {
            ...
            return UN.UnitConverter.Convert(qv, TemperatureUnit.Kelvin, TemperatureUnit.DegreeCelsius);
        }
        ...
        public static double FromDegreeCelsius(this double degreesCelsius)
        {
            ...
            return UN.UnitConverter.Convert(qv, TemperatureUnit.DegreeCelsius, TemperatureUnit.Kelvin);
        }
    }
}
