...
namespace BH.Engine.Units
{
    public static partial class Convert
    {
        ...
        public static double FromVolume(this double volume, VolumeUnit unit)
        {
            UN.QuantityValue qv = volume;
            return UN.UnitConverter.Convert(qv, unit, VolumeUnit.CubicMeter);
        }
        ...
        public static double ToVolume(this double cubicMeter, VolumeUnit unit)
        {
            UN.QuantityValue qv = cubicMeter;
            return UN.UnitConverter.Convert(qv, VolumeUnit.CubicMeter, unit);
        }
    }
}
